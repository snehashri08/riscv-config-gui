...
col1 = sg.Column(
    ...
    [[sg.Frame('Input ISA Yaml fields:', [[sg.Text(), sg.Column([[sg.Text('ISA:')],
                             [sg.Input( key='-ISA-', size=(19,1))],
                             [sg.Text('User_Spec_Version:')],
                             [sg.Input('2.3', key='-USER_SPEC-', size=(19,1))],
                             [sg.Text('supported_xlen:')],
                             [sg.Input(key='-XLEN-', size=(19,1))],
                             [sg.Text('physical_addr_sz:')],
                             [sg.Input(key='-PA_SZ-', size=(19,1))],
                             [sg.Text('pmp_granularity:')],
                             [sg.Input(key='-PMP-', size=(19,1))]
                             ], size=(235,350), pad=(0,0))]])]], pad=(0,0))

col3 = sg.Column([[sg.Frame('Actions:',
                            [[sg.Column([[sg.Button('Run in Riscv-Config'), sg.Button('Clear'), sg.Button('Delete'), ]],
